...
print('last train_loss=%f' %(train_loss))
print('last val_loss=%f' %(val_loss))
...
# 
# #### 请将你的答案填写在下方
#     根据图形显示，对于20天的预测，前10天的预测准确程度高于后10天。
#     问题主要出现在人数较少的日期区域。对于人数较多的日期该模型的预测更为准确，而人数较少的日期普遍预测人数高于实际人数。
#     一是超参数的设置，根据损失对比，并未达到完全拟合。二是简单对比测试数据，主观感觉在人数差异较大的日期里，各因素并显示出明显的差异。
